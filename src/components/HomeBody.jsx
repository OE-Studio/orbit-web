          ...
          <div className="w-[42%] self-start">
            ...
            flex opacity-0 group-hover:opacity-100 absolute w-full h-full bg-blue150 left-0 top-0 justify-between items-center pr-4 pl-6 z-10"
              ...
              <div className="flex w-full gap-5">
                {/* Data */}
                <div
                  className="flex-1 p-4 bg-purple25 rounded-[6px] cursor-pointer relative group overflow-hidden"
                  onClick={() => {
                    setTogglePurchaseData(true);
                  }}
                >
                  <div
            ...
            flex opacity-0 group-hover:opacity-100 absolute w-full h-full bg-purple100 left-0 top-0 justify-between items-center "
                ...
                {/* Airtime */}
                <div
                  className="flex-1 p-4 bg-[#EDFEF7] rounded-[6px] cursor-pointer relative group overflow-hidden"
                  onClick={() => {
                    setTogglePurchaseAirtime(true);
                  }}
                >
                  <div
                    className="transition duration-500 ease-in-out
            ...
            flex opacity-0 group-hover:opacity-100 absolute w-full h-full bg-[#D5E7CB] left-0 top-0 justify-between items-center "
                  ...
                  <div className="h-[42px] w-[42px] self-start inline-flex items-center justify-center bg-[#73B051] rounded-full">
                    ...
                    >
                      <path
                        d="M4.5 4.24219C3.70435 4.24219 2.94129 4.55826 2.37868 5.12087C1.81607 5.68348 1.5 6.44654 1.5 7.24219V7.99219H22.5V7.24219C22.5 6.44654 22.1839 5.68348 21.6213 5.12087C21.0587 4.55826 20.2956 4.24219 19.5 4.24219H4.5Z"
                        fill="#F1F7EE"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M22.5 10.2422H1.5V17.7422C1.5 18.5378 1.81607 19.3009 2.37868 19.8635C2.94129 20.4261 3.70435 20.7422 4.5 20.7422H19.5C20.2956 20.7422 21.0587 20.4261 21.6213 19.8635C22.1839 19.3009 22.5 18.5378 22.5 17.7422V10.2422ZM4.5 13.9922C4.5 13.7933 4.57902 13.6025 4.71967 13.4619C4.86032 13.3212 5.05109 13.2422 5.25 13.2422H11.25C11.4489 13.2422 11.6397 13.3212 11.7803 13.4619C11.921 13.6025 12 13.7933 12 13.9922C12 14.1911 11.921 14.3819 11.7803 14.5225C11.6397 14.6632 11.4489 14.7422 11.25 14.7422H5.25C5.05109 14.7422 4.86032 14.6632 4.71967 14.5225C4.57902 14.3819 4.5 14.1911 4.5 13.9922ZM5.25 16.2422C5.05109 16.2422 4.86032 16.3212 4.71967 16.4619C4.57902 16.6025 4.5 16.7933 4.5 16.9922C4.5 17.1911 4.57902 17.3819 4.71967 17.5225C4.86032 17.6632 5.05109 17.7422 5.25 17.7422H8.25C8.44891 17.7422 8.63968 17.6632 8.78033 17.5225C8.92098 17.3819 9 17.1911 9 16.9922C9 16.7933 8.92098 16.6025 8.78033 16.4619C8.63968 16.3212 8.44891 16.2422 8.25 16.2422H5.25Z"
                        fill="#F1F7EE"
                      />
                    </svg>
                  </div>

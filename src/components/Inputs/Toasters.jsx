...
const Toaster = ({ error, onClose }) => {
  ...
  return (
    ...
    shadow-[0px_4px_6px_-2px_#1018280D,_0px_12px_16px_-4px_#1018281A] p-4 w-[calc(100%-32px)] md:w-[546px] bg-white top-14 z-20 rounded-lg overflow-hidden flex justify-between
    "
        >
